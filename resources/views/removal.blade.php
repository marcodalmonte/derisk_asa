...
if (empty($prelims) and empty($removal['id'])) {
    $prelims = '<font color="#365f91"><span style="font-weight:bold;">Requirements of quotation</span></font><br><br><span>Contractors must attend a pre-arranged accompanied site visit with Derisk (UK) Ltd to assess the works prior to submitting costs and programme.</span><br><br><span>This specification is for the removal of asbestos containing materials identified in the following areaa at .......................... by a Licensed Asbestos Removal Contractor (LARC) to allow .......................... work to be undertaken.</span><br><br><span>The information within this specification is based on the following HSG264 surveys undertaken by Derisk (UK) Ltd</span><br><ul><li>..........................</li></ul><br><br><span>Extracts from the surveys are included within this specification but the full reports are available for review and inspection upon request.</span><br><br><span>Photographic evidence, dimensions and observations from the survey are provided as part of this specification for remediation works. All dimensions should be taken as a guide, it is the responsibility of the contractor to ensure to make their own estimates for tendering purposes.</span><br><br><span style="font-weight:bold;">The Contractor is not required to include any costs for air testing as this will be procured independently.</span><br><br><font color="#365f91"><span style="font-weight:bold;">General Conditions/Requirements</span></font><br><br><span>The property is a ........................... The works must be designed to protect any other persons from the works including maintaining a secure segregated working area to incorporate the enclosure and, where deemed necessary, a secure site compound/area to incorporate the hygiene unit and waste receptacle/local waste storage area.</span><br><br><span>Working hours are 0800 – 1700 hrs Monday – Sunday. The LARC shall devise a program that is appropriate and suitable for the location of the site to allow access into the site and also for the delivery of materials, plant or equipment and for the safe and appropriate disposal of waste from the site. All costs associated with transport, parking and any necessary local permits are deemed included within their tender bid. The LARC is responsible for assessing the requirements for parking and or any local permits.</span><br><br><span>The site is .......................... but consideration must be given to waste runs or where waste can be safely stored until it can be taken from . Any temporary waste storage areas are deemed included within the tender submitted and this shall include any making good where temporary waste storage areas are built inside the main building.</span><br><br><span>The Contractor must ensure there is suitable provision for alerting operatives inside the enclosure and also for operatives to raise an alarm that may originate from inside the enclosure. No hot works will be allowed inside any work area without permission of the Client Safety Team. The proposed system for fire precautions will be agreed with the Client prior to commencement of the project works.</span><br><br><font color="#365f91"><span style="font-weight:bold;">Site set up (preliminary notes)</span></font><br><br><span>The floor plans attached are from the surveys to provide reference to the observations, sample analysis and the room references. The licensed contractor will need to create their own plans to define the site set-up. These can be provided to the successful contractor.</span><br><br><span>All facilities required by the LARCs work will need to be contained within the building. The client has .......................... space outside of the building.</span><br><br><span>The Contractors shall ensure they have visited site and familiarised themselves with the local site conditions and specification requirements and local site rules.</span><br><br><span>Power and water are/are not available on site and to be agreed with the client for use, the Contractors shall ensure adequate services are available when the Plan of Work is prepared.</span><br><br><span>Lighting remains live within the building although the contractor shall ensure provision of all adequate task lighting to safely carry out their specified works.<br>The contractor shall remain responsible for organising the works in the most efficient timescale and shall be deemed responsible for progression of the program and in reducing all delays.</span><br><br><span>Welfare is available in the ........................... the Contractor remains responsible for ensuring that these facilities remain safe, clean and tidy. However, the contractor shall ensure adequate welfare is available once the enclosure is built. The Contractor shall be responsible to the client in the event that these facilities require cleaning as a result of use by the Contractor.</span><br><br><span>The Contractor shall ensure they provide all adequate welfare facilities for the number of operatives to be utilised during the planned works. All costs associated with the delivery, provision and maintenance of welfare facilities is deemed included within the final tendered price submitted by the Contractor. These shall remain the responsibility and liability of the Contractor at all times.</span><br><br><span>The contractor shall remain responsible for organising the works in the most efficient timescale and shall be deemed responsible for ensuring the agreed programme is met. No additional costs can be submitted if the programme is delayed unless the delay is through no fault of the contractor and agreed with .......................... and Derisk (UK) Ltd prior to the event. Retrospective variations will not be considered.</span>';
}
...
if (empty($tenderSubmission) and empty($removal['id'])) {
    $tenderSubmission = '<span>As part of the tender submission and quotation for these works you are to return a signed copy of this document supported with the following information in an electronic format:</span><br><br><ul><li>Copy of Company’s asbestos license</li><li>Copy of Company’s insurance schedule</li><li>Company’s organisation and proposed project organisation </li><li>Copies of any trade body or other recognised professional memberships</li><li>Program of works</li></ul><br><br><span>The tender will be reviewed and the company’s may then be asked to attend a post tender review meeting, at this meeting you will be required to explain your methodology and table any tender clarifications.</span><br><br><span>The tender submission will be evaluated utilising the following scoring criterion:</span><br><br><span style="font-weight: bold;">Health and Safety &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 50%</span><br><span style="font-weight: bold;">Commercial &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 30%</span><br><span style="font-weight:bold;">Quality of submission&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 20%</span><br><br><span>The successful contractor will be notified via telephone and email with instruction to prepare and submit the necessary notifications to HSE, on completion of the notification a copy of the ASB5 and accompanying plan of work will be sent to the contract administrator for review and authorisation.</span>';
}
